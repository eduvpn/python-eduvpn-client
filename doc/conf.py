# -*- coding: utf-8 -*-
#
# python-eduvpn-client documentation build configuration file, created by
...
htmlhelp_basename = 'python-eduvpn-clientdoc'
...
latex_documents = [
    (master_doc, 'python-eduvpn-client.tex', u'python-eduvpn-client Documentation',
     u'Gijs Molenaar', 'manual'),
]
...
man_pages = [
    (master_doc, 'python-eduvpn-client', u'python-eduvpn-client Documentation',
     [author], 1)
]
