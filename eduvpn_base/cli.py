...
import eduvpn_base.nm as nm
from eduvpn_base import __version__
from eduvpn_base.app import Application
from eduvpn_base.i18n import country, retrieve_country_name
from eduvpn_base.server import ServerDatabase
from eduvpn_base.settings import CONFIG_DIR_MODE
from eduvpn_base.ui.search import ServerGroup, group_servers
from eduvpn_base.ui.utils import get_validity_text, should_show_error
from eduvpn_base.utils import cmd_transition, init_logger, run_in_background_thread
...
def main(variant):
    _common = common.EduVPN(variant.client_id, str(__version__), str(variant.config_prefix), country())
    cmd = CommandLine(variant, _common)
    cmd.start()
