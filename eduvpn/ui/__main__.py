...
def get_variant_settings(variant) -> Tuple[str, str, str]:
    language = country()
    if variant == EDUVPN:
        return CLIENT_ID, str(CONFIG_PREFIX), language
    return LETSCONNECT_CLIENT_ID, str(LETSCONNECT_CONFIG_PREFIX), language
